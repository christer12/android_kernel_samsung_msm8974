...
VIKAL_PROJECT ?= $(shell $(PERL) -e '$$of = "n"; while (<>) { if (/CONFIG_SEC_VIKAL_PROJECT=y/) { $$of = "y"; break; } } print $$of;' $(KERNEL_CONFIG))
...
ifeq "$(V2_PROJECT)" "y"
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/$(DTS_NAME)-sec-v2lte*.dts)
endif
ifeq "$(LT03_PROJECT)" "y"
	ifeq "$(LOCALE_KOR)" "y"
...
ifeq "$(VIKAL_PROJECT)" "y"
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/$(DTS_NAME)-sec-vikal*.dts)
endif
ifeq "$(F_PROJECT)" "y"
		ifeq "$(LOCALE_KOR)" "y"
