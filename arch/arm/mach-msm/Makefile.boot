...
# flte kor device tree
	...
	dtb-y	+= msm8974-sec-flte-r04.dtb
	dtb-y	+= msm8974-sec-flte-r05.dtb
	dtb-y	+= msm8974-sec-flte-r06.dtb
	dtb-y	+= msm8974-sec-flte-r07.dtb
	dtb-y	+= msm8974-sec-flte-r08.dtb
endif
endif
ifeq ($(CONFIG_SEC_V2_PROJECT),y)
	dtb-y	+= msm8974-sec-v2lte-r00.dtb
endif
	...
	dtb-$(CONFIG_SEC_MONTBLANC_PROJECT)	+= msm8974-sec-montblanc-r04.dtb
	dtb-$(CONFIG_SEC_MONTBLANC_PROJECT)	+= msm8974-sec-montblanc-r05.dtb
	...
	dtb-$(CONFIG_SEC_VIKAL_PROJECT)	+= msm8974-sec-vikal-r00.dtb
	dtb-$(CONFIG_SEC_VIKAL_PROJECT)	+= msm8974-sec-vikal-r01.dtb
	dtb-$(CONFIG_SEC_VIKAL_PROJECT)	+= msm8974-sec-vikal-r02.dtb
	dtb-$(CONFIG_SEC_VIKAL_PROJECT)	+= msm8974-sec-vikal-r03.dtb

ifeq ($(CONFIG_SEC_LT03_PROJECT),y)
       	dtb-y += msm8974-sec-lt03-r00.dtb
       	dtb-y += msm8974-sec-lt03-r05.dtb
       	dtb-y += msm8974-sec-lt03-r07.dtb
       	dtb-y += msm8974-sec-lt03kor-r02.dtb
       	dtb-y += msm8974-sec-lt03kor-r06.dtb
       	dtb-y += msm8974-sec-lt03kor-r07.dtb
endif
