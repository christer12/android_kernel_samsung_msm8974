...
static void sdhci_dumpregs(struct sdhci_host *host)
{
	...
	pr_info(DRIVER_NAME ": Rsp[31:0]: 0x%08x | Rsp[63-32]: 0x%08x\n",
		sdhci_readl(host, SDHCI_RESPONSE),
		sdhci_readl(host, SDHCI_RESPONSE + 0x4));
	pr_info(DRIVER_NAME ": Rsp[95:64]: 0x%08x | Rsp[127:96]: 0x%08x\n",
	...
	if (host->ops->dump_vendor_registers)
		host->ops->dump_vendor_registers(host);
